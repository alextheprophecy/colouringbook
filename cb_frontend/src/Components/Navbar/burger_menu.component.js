            ...
            <div className="flex flex-col space-y-2 absolute bottom-4 left-0 w-full">
                {isUserLoggedIn() ?
                    <>
                        ...
                        <button 
                            className="w-full text-red-600 bg-transparent hover:bg-red-800 px-4 py-2.5 rounded-lg text-sm md:text-base  font-medium transition-all duration-200 flex items-center justify-center" 
