...
import { LogOut, LogIn, Home, Info, SwitchCamera, BookCopy, BookPlus } from 'lucide-react';
            ...
            >
                ...
                <div className="relative z-[50] flex flex-col space-y-4 h-full">
                    <div className="flex flex-col space-y-4">
                        ...
                        {isUserLoggedIn() && getMenuLink('/create', t('login.create'), 'bg-blue-600 hover:bg-blue-700 text-white', <BookPlus className="w-5 h-5" />)}
                        ...
                        <div className="mt-auto">
                            {getMenuLink('/about', t('login.about'), 'text-gray-600 bg-transparent hover:bg-gray-800 border border-gray-700 text-white', <Info className="w-5 h-5" />)}
                        </div>
                        {login_logout_button()}
                    </div>   
                </div>
