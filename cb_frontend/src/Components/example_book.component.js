...
const ExampleBook = () => {
    ...
    const BOOK1 = {title: "A football game where the nice rabbits win against the mean dogs", pages_directory: "assets/images/book-football-rabbits/",
        pages: ['out-0.jpg','pic4.jpg', 'pic2.jpg', 'pic3.jpg', 'pic6.jpg', 'pic7.jpg', 'pic5.jpg']}

    const BOOK2 = {title: "Happiness, friendship, fantasy, fairy, gnomes, teamwork", pages_directory: "assets/images/book1/",
        pages: ['im0.jpg', 'im1.jpg', 'im2.jpg', 'im3.jpg', 'im4.jpg', 'im5.jpg']}

    const BOOK3 = {title: "Batman and mario playing different sports together, happiness, outdoors", pages_directory: "assets/images/book-mario-batman/",
        pages: ['img0.jpg', 'img1.jpg', 'img2.jpg', 'img5.jpg', 'img4.jpg', 'img3.jpg']}

    const BOOK4 = {title: "Turn any scenario into a colouring page!", pages_directory: "assets/images/one-page-examples/",
    ...
    const BOOK5 = {title: "Give specific prompts for each page", pages_directory: "assets/images/multiple_prompts/",
