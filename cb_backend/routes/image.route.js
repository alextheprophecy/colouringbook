...
const {generatePageWithContext, regeneratePage, enhancePage, getBookPDF, generateBookPDF} = require("../controllers/book/colouring_book.controller");
...
router.post('/finishBook', [verifyToken, verifyBook], generateBookPDF);
