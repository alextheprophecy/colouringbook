...
const {generatePageDescriptionAndUpdateContext} = require("../controllers/book/descriptions_controller");
...
router.post('/generatePageDescription', generatePageDescriptionAndUpdateContext)
